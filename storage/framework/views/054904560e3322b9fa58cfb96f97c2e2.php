    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo e(route("admin.auth.logout")); ?>">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /Volumes/Server/public_html/ostad/ostad_module12_assignment/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>