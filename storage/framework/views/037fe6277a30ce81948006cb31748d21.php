                            ...
                            <div class="form-group">
                                ...
                                <select name="trip_id" id="trip_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($trip->id); ?>"><?php echo e($trip->route->origin . " - " . $trip->route->destination); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                                    ...
                                    <tr>
                                        <td class="px-0" colspan="2">
                                            <label class="d-inline">
                                                <input type="date" value="<?php echo e(now()->toDateString()); ?>" id="booking_time" class="form-control form-control-sm w-100">
                                                <small id="day_name" class="form-text text-muted"></small>
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="px-0">
                                            <label class="d-inline">
                                                ...
                                                <small id="error_passenger_name" class="form-text text-danger"></small>
                                            </label>
                                        </td>
                                        <td class="pr-0">
                                            <label class="d-inline">
                                                <input type="text" class="form-control form-control-sm w-100" placeholder="Email Address or Phone *" id="passenger_email_or_phone">
                                                <small id="error_passenger_email_or_phone" class="form-text text-danger"></small>
                                            </label>
                                        </td>
                                        <td class="float-right px-0">
...
<?php $__env->startPush("scripts"); ?>
    <script>
        ...
        trip_id_element.on("change", function () {
            ...
            jQuery.ajax({
                method: "GET",
                url: "<?php echo e(route("admin.tickets.sub_route_ajax")); ?>",
        ...
        function findTicket() {
            ...
            jQuery.ajax({
                method: "GET",
                url: "<?php echo e(route("admin.tickets.tickets_ajax")); ?>",
        ...
        create_ticket_btn_element.on("click", function() {
            ...
            if (valid) {
                ...
                jQuery.ajax({
                    method: "POST",
                    url: "<?php echo e(route("admin.tickets.tickets_create_ajax")); ?>",
                    data: data,
                    beforeSend: function () {
                        create_ticket_btn_element.prop("disabled", true);
...
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Server/public_html/ostad/ostad_module12_assignment/resources/views/admin/tickets/create.blade.php ENDPATH**/ ?>