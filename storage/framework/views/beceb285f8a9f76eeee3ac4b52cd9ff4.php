...
<?php $__env->startSection("content"); ?>
    ...
    <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="<?php echo e(route("admin.routes.update", $route->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" step="any" class="form-control" id="distance" value="<?php echo e($route->distance); ?>"
                                   name="distance">
                        </div>
                    </div>
...
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Server/public_html/ostad/ostad_module12_assignment/resources/views/admin/routes/edit.blade.php ENDPATH**/ ?>